...
var  typescript =require('rollup-typescript');
...
module.exports=function(arg,cb){
  var result={};
  result.input={
    input: path.resolve(root,'temp/snabbdom/snabbdom.bundle.ts'),
    plugins: [
      resolve(),
      commonjs(),
      typescript()
  ...
  result.output={
    file: path.resolve(root, 'dist/snabbdom/snabbdom.bundle.js'),
    format: 'umd',
    name:'snabbdom',
    exports:'named',
    sourcemap:false,
